...
class InstitutionProductSort_API(object):
    @Base_API("sql_script_request.ini","sql_script_post_institutionModule","institutionProductSort")
    def institutionProductSort_api(obj):
        body = obj[1]
    ...
    def __call__(self, *args, **kwargs):
        ...
        source("sql_script_request.ini","sql_script_post_institutionModule","institutionProductSort")
        #发送请求
